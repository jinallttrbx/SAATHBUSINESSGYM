...
class VideosDetailsScreen extends StatefulWidget {
  Videos? videos;
  VideosDetailsScreen({Key? key, this.videos}) : super(key: key);

  @override
  State<VideosDetailsScreen> createState() => _VideosDetailsScreenState();
}

class _VideosDetailsScreenState extends State<VideosDetailsScreen> {
  ...
  addLike() async {
    ...
    try {
      print(USERTOKKEN);
      print(widget.videos!.vid.toString());
      final response = await http.post(
        ...
        body: {
          'video_id': widget.videos!.vid.toString(),
        },
      );
      ...
      hideLoader();
      sendPostRequest(widget.videos!.vid.toString());
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  void initState() {
    controller = PodPlayerController(
      playVideoFrom: PlayVideoFrom.youtube(widget.videos!.youtubeUrl!,
          videoPlayerOptions:
    ...
    String? videoId;
    videoId = YoutubePlayer.convertUrlToId("" + widget.videos!.youtubeUrl!);
    print(videoId);
            ...
            children: [
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => VideoPlayerScreen(
                                video_urle: widget.videos!.youtubeUrl,
                              ),
                            ),
                          );
                        },
              ...
              Padding(
                ...
                child: boldtext(AppColors.black, 18,
                  widget.videos!.videoTital!.toString(),
                ),
              ),
              vertical(10),
              Padding(
                ...
                child: regulartext(AppColors.blackShade4, 12,
                  widget.videos!.videoShortDescription!.toString(),
                ),
              ),
              const SizedBox(
                height: 30,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text(widget.videos!.videoDuration.toString()),
