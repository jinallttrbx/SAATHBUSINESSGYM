...
class ProviderproductsearchScreen extends StatefulWidget {
  String text;
  String type;
  ProviderproductsearchScreen(this.text,this.type);
  @override
  ProviderproductearchScreenState createState() => ProviderproductearchScreenState();
}
class ProviderproductearchScreenState extends State<ProviderproductsearchScreen> {
