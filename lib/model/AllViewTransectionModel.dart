...
class AllViewTransectionModel {
  ...
  AllViewTransectionModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(TransectionData.fromJson(v));
      });
    }
  }
...
class TransectionData {
  String? date;
  List<TransectionSubData>? subData;

  TransectionData({this.date, this.subData});

  TransectionData.fromJson(Map<String, dynamic> json) {
    date = json['date'];
    if (json['sub_data'] != null) {
      subData = <TransectionSubData>[];
      json['sub_data'].forEach((v) {
        subData!.add(TransectionSubData.fromJson(v));
      });
    }
  }
...
class TransectionSubData {
  ...
  TransectionSubData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
