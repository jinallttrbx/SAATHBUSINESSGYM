...
class LeadDataModel {
  ...
  factory LeadDataModel.fromJson(Map<String, dynamic> json) => LeadDataModel(
    ...
    data: List<LeadDataModeldata>.from(json["data"].map((x) => LeadDataModeldata.fromJson(x))),
  );
...
class LeadDataModeldata {
  ...
  factory LeadDataModeldata.fromJson(Map<String, dynamic> json) => LeadDataModeldata(
    id: json["id"],
    userId: json["user_id"],
